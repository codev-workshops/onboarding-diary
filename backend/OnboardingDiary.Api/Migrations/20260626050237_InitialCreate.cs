    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueEntries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoteEntries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NoteEntryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoteTags_NoteEntries_NoteEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueEntries_Date",
                table: "IssueEntries",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_IssueEntries_UserId",
                table: "IssueEntries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NoteEntries_Date",
                table: "NoteEntries",
                column: "Date");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteTags_NoteEntryId_Tag",
                table: "NoteTags",
                columns: new[] { "NoteEntryId", "Tag" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaskEntries_Date",
                table: "TaskEntries",
                column: "Date");
