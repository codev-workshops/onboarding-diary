...
/**
 * M1 placeholder shell. It exists to prove the Tailwind + shadcn/ui pipeline
 * renders and to state plainly which milestone the codebase is at; the real
 * dashboard arrives in M6.
 */
const milestones = [
  { id: 'M1', title: 'Skeleton, database schema, seed data', status: 'done' as const },
  { id: 'M2', title: 'Authentication (signup, login, session cookie)', status: 'next' as const },
  { id: 'M3', title: 'Authorization module and scoped repository', status: 'planned' as const },
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-8 px-6 py-16">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The skeleton, database schema and seed data are in place. Authentication, authorization and the
            application APIs are not implemented yet — see the README for what each milestone adds.
          </CardDescription>
        </CardHeader>
        <CardContent>
