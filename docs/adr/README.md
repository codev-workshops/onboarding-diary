...
authentication scope, trunk-based development on `main`, hard deletes, Department as reference
data, incremental schema per milestone, no outbound email, API conventions, the authorization
model and the testing strategy are specified in
